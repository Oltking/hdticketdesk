...
export function Sidebar({ type }: SidebarProps) {
  ...
  const organizerLinks = [
    ...
    { href: '/events/create', label: 'Create Event', icon: Plus, highlight: true },
    { href: '/payments', label: 'Payment History', icon: Receipt },
    { href: '/payouts', label: 'Payouts', icon: DollarSign },
    { href: '/refunds', label: 'Refund Requests', icon: RotateCcw },
  ...
  const adminLinks = [
    ...
    { href: '/admin/payments', label: 'Payments (Recovery)', icon: CreditCard },
    { href: '/admin/payments/explorer', label: 'Payments Explorer', icon: CreditCard },
